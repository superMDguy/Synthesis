...
static Tobj eeval (Tobj, long);
static Tobj efcall (Tobj, long);
static void ewhilest (Tobj, long);
static void eforst (Tobj, long);
static void eforinst (Tobj, long);

static Tobj getval (Tobj, long);
static int getvar (Tobj, long, tnk_t *);
...
static void err (int, int, Tobj, long);
...
Tobj Efunction (Tobj co, char *ifnam) {
    ...
    v1o = Tcode (TCgetaddr (co, fi), fi,
            TCgetinteger (co, TCgetfp (co, fi)));
    Tinss (root, ifnam, v1o);
    return v1o;
}

static Tobj eeval (Tobj co, long ci) {
    Tobj v1o, v2o, v3o;
    Ttype_t ttype;
    Ctype_t ctype;
    tnk_t tnk;
...
static Tobj efcall (Tobj co, long ci) {
    volatile jmp_buf *opljbufp1, *opljbufp2;
    volatile long bi, m, ownsinfoi, li, ln;

    jmp_buf pljbuf;
    Tobj fdo, vo, lrtno;
    long i, fci, ai, di, di1, fid;
    ...
    ln = TCgetinteger (fdo, (li = TCgetnext (fdo, TCgetfp (fdo, 0))));
    di = TCgetnext (fdo, li);
    bi = TCgetnext (fdo, di);
    if (bi != C_NULL && TCgettype (fdo, bi) == C_INTERNAL) {
        ...
        fid = TCgetinteger (fdo, TCgetfp (fdo, bi));
        ...
        if ((*Ifuncs[fid].func) (i, &lvarp[flvari]) == FAILED)
...
static void ewhilest (Tobj co, long ci) {
...
static void eforst (Tobj co, long ci) {
    volatile jmp_buf *opljbufp;
    volatile jmp_buf pljbuf;
    volatile Tobj c1o;
    volatile long ei1, ei2, ei3, si, eisnop1, eisnop2, eisnop3;
...
static void eforinst (Tobj co, long ci) {
    volatile jmp_buf *opljbufp;
    volatile jmp_buf pljbuf;
    volatile Tobj tblo, c1o;
    volatile Tkvindex_t tkvi;
    volatile tnk_t tnk;
    volatile long ei1, ei2, si, km, t;
...
static Tobj getval (Tobj co, long ci) {
    Tobj cvo, cko, cto;
    Ctype_t ct, vt;
    long vi, ni, nn;

    if ((ct = TCgettype (co, ci)) == C_LVAR) {
        nn = TCgetinteger (co, (ni = TCgetnext (co, TCgetfp (co, ci))));
...
static int getvar (Tobj co, long ci, tnk_t *tnkp) {
    Tobj cvo, cko, cto;
    Ctype_t ct, vt;
    long vi, ovi, m, nn, ni;
...
static void setvar (tnk_t tnk, Tobj vo) {
    ...
    default:
        ...
        case C_REAL:
            Tinsr (tnk.u.tnks.to,
                    TCgetreal (tnk.u.tnks.co, tnk.u.tnks.vi), vo);
            break;
        }
        break;
    }
...
static void err (int errnum, int level, Tobj co, long ci) {
    char *s;
    long si, i;
